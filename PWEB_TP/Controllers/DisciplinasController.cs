...
namespace PWEB_TP.Controllers
{
    ...
    public class DisciplinasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DisciplinaId,Ramo,Nome")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DisciplinaId,Ramo,Nome")] Disciplina disciplina)
        {
            if (ModelState.IsValid)
            {
